<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/hg/index.php?s=/Home/Contract/look">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/hg/index.php?s=/Home/Contract/look" method="post">
	<input type="hidden" name="numPerPage" value="<?php echo ($numPerPage); ?>" />
	<div class="searchBar">
	...
	<table class="table" width="100%" layoutH="112">
		...
		<tbody>
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr target="item_id" rel="<?php echo ($vo["id"]); ?>">
				...
				<td><neq name="vo.status" value="0"><a href="/hg/index.php?s=/Home/Contract/detail/id/<?php echo ($vo["id"]); ?>/isother/<?php echo ($vo["isother"]); ?>" target="dialog" height="600" width="1024" rel="Contractdetail"><span><b>[详情]</b></span></a></eq></td>
