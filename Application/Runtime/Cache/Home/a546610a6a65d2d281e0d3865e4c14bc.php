<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/hg/index.php?s=/Home/Zhixingadmin/useggoverlook">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="edit" href="/hg/index.php?s=/Home/Zhixingadmin/useedit/id/{item_id}" target="navTab" rel="Placardedit"><span>修改</span></a></li>
			<li><a class="delete" href="/hg/index.php?s=/Home/Zhixingadmin/usedelete/id/{item_id}/navTabId/Zhixingadminuseggoverlook" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
		</ul>
	</div>
	<table class="list" width="100%" layoutH="56">
		...
		<tbody>
			...
			<tr target="item_id" rel="<?php echo ($vo["id"]); ?>">
				...
				<td width="120"><?php echo ($vo["year"]); ?></td>
				<td width="120"><?php echo ($vo["month"]); ?></td>
