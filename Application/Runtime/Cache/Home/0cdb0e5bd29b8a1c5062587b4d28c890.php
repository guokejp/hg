...
<div class="pageContent" layoutH="0" >
    <form rel="pageForm" onsubmit="return navTabSearch(this);" action="/hg/index.php?s=/Home/Zhixingadmin/looktype1" method="post">
    <h4 style="margin-left:300px;margin-bottom:0px;font-size:1.7em;letter-spacing:10px">预算执行行政表按科目查询（单位：万元）</h4>
    ...
    <table width="1100" border="1" style="border-collapse:collapse;margin-left:10px;clear:both">
        <tr>
            <td height="55" rowspan="2" align="center" valign="middle">资金科目</td>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                <td height="25" valign="middle"><?php echo ($list["kemuname"]); ?></td>
