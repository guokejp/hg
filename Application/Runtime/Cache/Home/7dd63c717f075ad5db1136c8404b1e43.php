<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/hg/index.php?s=/Home/Spebudget/spelogdata">
...
<div class="pageHeader">
	<form rel="pagerForm" action="/hg/index.php?s=/Home/Spebudget/spelogdata" onsubmit="return dialogSearch(this);" method="post">
	<input type="hidden" name="numPerPage" value="<?php echo ($numPerPage); ?>" />
	...
	<table class="table" width="100%" layoutH="90">
		<thead>
			<tr>
				<th width="40">ID</th>
				<th width="80">专项单位</th>
				<th width="100">专项部门</th>
				<th width="160">专项名称</th>
				<th width="80">报销人</th>
				<th width="100">报销单号</th>
				<th width="80">报销金额</th>
				<th width="100">是否采购合同报销</th>
				<th width="70">报销时间</th>
			</tr>
		</thead>
		<tbody>
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr target="item_id" rel="<?php echo ($vo["id"]); ?>">
				...
				<td>
					<?php if($vo["type"] == 1): elseif($vo["type"] == 2): ?><b>采购合同报销</b><?php endif; ?>
				</td>
				<td><?php echo ($vo["logdate"]); ?></td>
