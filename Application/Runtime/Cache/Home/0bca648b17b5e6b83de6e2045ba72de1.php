<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/hg/index.php?s=/Home/Spebudget/getcheck">
...
<div class="pageHeader">
	<form rel="pagerForm" action="/hg/index.php?s=/Home/Spebudget/getcheck" onsubmit="return dialogSearch(this);" method="post">
	<input type="hidden" name="numPerPage" value="<?php echo ($numPerPage); ?>" />
